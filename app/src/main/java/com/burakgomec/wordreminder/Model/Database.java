...
public class Database extends SQLiteOpenHelper {
    ...
    public ArrayList<TranslatedWord> translatedWordArrayList = new ArrayList<>();
    ...
    public void getWords(){
        ...
        while (cursor.moveToNext()){
            ...
            translatedWordArrayList.add(translatedWord);
        }
        cursor.close();
        database.close();
    }
    ...
    public void deleteWordWithId(TranslatedWord translatedWord){
        ...
        translatedWordArrayList.remove(translatedWord);
        database.close();
    }
